...
g.tnode(10)
# Making the Graph
g.addEdge(0, 1, 1); g.addEdge(0, 2, 1); g.addEdge(1, 4, 2);
g.addEdge(2, 3, 2); g.addEdge(3, 4, 1); g.addEdge(3, 7, 3);
g.addEdge(4, 8, 3); g.addEdge(5, 6, 4); g.addEdge(6, 8, 4);
g.addEdge(7, 4, 3); g.addEdge(0, 8, 11); g.addEdge(1, 8, 10);
